...
class AttenAlignBlock(nn.Module):
...
class AttenAlignModel(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.h = nn.ModuleList([AttenAlignBlock(config, layer_idx=i) for i in range(config.num_hidden_layers)])
...
class AttenAlignLMHeadModel(GPT2PreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"attn.masked_bias", r"attn.bias", r"lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.transformer = AttenAlignModel(config)
...
class AttenAlignTransformer(nn.Module): 
    def __init__(self, vision_config, language_config):
        ...
        self.language_decoder = AttenAlignLMHeadModel(language_config) 
